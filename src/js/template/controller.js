...
class TplController {
  ...
  init() {
    // controller
    const _progress = '.atplayer-controls--warp .atplayer-controls--progress';
    const _content = '.atplayer-controls--warp .atplayer-controls--content';
    ...
    const fullscreenIcon = _cd.querySelector(
      `.atplayer-fullscreen-btn .atplayer-fullscreen-icon`
    );
