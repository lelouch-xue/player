...
class DPlayer {
  ...
  constructor(options) {
    ...
    if (this.options.live) {
      ...
      this.container.classList.add('atplayer-live');
    } else {
      this.container.classList.remove('dplayer-live');
      this.container.classList.remove('atlayer-live');
    }
    if (utils.isMobile) {
  ...
  initVideo(video, type) {
    ...
    this.on('timeupdate', () => {
      ...
      this.bar.set('barPlayed', this.video.currentTime / this.video.duration, 'width');
