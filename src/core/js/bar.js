class Bar {
  constructor(template) {
    ...
    this.elements.barPlayed = template.controller.barPlayed;
    this.elements.barLoaded = template.controller.barLoaded;
    this.elements.barVolume = template.controller.volumeBar;
  }
